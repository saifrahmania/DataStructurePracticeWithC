...
using namespace std;
/*
Problem:  An arithmetic array is an array that contains at least two integers and the differences between 
...
Saphiya has an array of N non-negative integers. The i-th integer of the array is A.
...
The second line contains N integers. The i-th integer is A.
